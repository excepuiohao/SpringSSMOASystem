	...
	<div class="row ">
		...
		<div class="col-sm-9 col-md-10 " style="padding-top: 100px">
			<div class="row ">
				...
				<form action="UpdateProjectProcess" onsubmit="return checkForm();">
					<div class="container regist">
						...
						<div class="row">
							<div class="col-xs-3"></div>
							<div class="col-xs-6 regist_input">
								<input class="form-control" type="text" name="ProjectProcess" id="ProjectProcess"
									placeholder="请输入项目进度">
							</div>
							<div class="col-xs-3"></div>
						</div>
