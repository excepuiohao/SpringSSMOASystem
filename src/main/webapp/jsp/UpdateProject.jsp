				...
				<form action="UpdateProject2" onsubmit="return checkForm();">
					<div class="container regist">
						...
						<div class="row">
							...
							<div class="col-xs-6 regist_input">
								<input class="form-control" type="text" name="ProjectContent"  id="ProjectContent"
									placeholder="项目内容为：<%=project.getProjectContent()%>">
							</div>
							<div class="col-xs-3"></div>
						</div>
						<div class="row">
							...
							<div class="col-xs-6 regist_input">
								<input class="form-control" type="text" name="ProjectTime" id="ProjectTime"
									placeholder="项目时间为：<%=project.getProjectTime()%>">
							</div>
							<div class="col-xs-3"></div>
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-6 regist_input">
								<input class="form-control" type="text" name="ProjectMoney"  id="ProjectMoney"
									placeholder="项目预算为：<%=project.getProjectMoney()%>">
							</div>
							<div class="col-xs-3"></div>
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-6 regist_input">
								<input class="form-control" type="text" name="ProjectPMId" id="ProjectPMId"
									placeholder="项目负责人为：<%=project.getProjectPMId()%>">
							</div>
							<div class="col-xs-3"></div>
						</div>
						...
						<div class="row" style="display: none">
							<div class="col-xs-3"></div>
							<div class="col-xs-6 regist_input">
								<input class="form-control" type="text" name="ProjectId"
