<%@page import="com.util.UserProjectProcess"%>
		...
		<div class="col-sm-9 col-md-10 col-md-offset-1 " style="padding-top: 100px">
			<div class="row ">
				...
				<div
					...
					<span
						style="width: 92px; height: 35px; font-size: 20px; padding: 8px 0px 0px 10px; margin-top: 3px;">项目进度</span>
				</div>
				<table class="table table-hover table-striped table -borderd">
					<%
						List<UserProjectProcess> list = (List<UserProjectProcess>) request.getAttribute("list");
					%>
					<thead>
						<!-- table  标题栏   -->
						<tr>
					...
					<tbody>
						...
						<tr>
							...
							<td><%=list.get(i).getProjectProcess()%></td>
						</tr>
