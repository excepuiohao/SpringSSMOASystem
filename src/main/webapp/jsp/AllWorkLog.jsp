		...
		<div class="col-sm-9 col-md-10 col-md-offset-1" style="padding-top: 100px">
			<div class="row ">
				...
				<div
					...
					<span
						style="width: 92px; height: 35px; font-size: 20px; padding: 8px 0px 0px 10px; margin-top: 3px;">日志信息</span>
					<a href="../jsp/InsertWorkLog.jsp"
						style="float: right; font-size: 16px; margin: 5px 38px 0px 0px;">发布日志</a>
				</div>
				<table class="table table-hover table-striped table -borderd">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=list.get(i).getLogContent()%></td>
							
							<!-- 删除 -->
							<td><a href="DeleteWorkLog?LogId=<%=list.get(i).getLogId()%>"><span
