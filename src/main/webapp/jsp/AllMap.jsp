		...
		<div class="col-sm-9 col-md-10 col-md-offset-1" style="padding-top: 100px">
			<div class="row ">
				...
				<div
					...
					<a href="../jsp/InsertMap.jsp"
						style="float: right; font-size: 16px; margin: 5px 38px 0px 0px;">新增地图信息</a>
				</div>
				<table class="table table-hover table-striped table -borderd">
					...
					<tbody>
						...
						<tr>
							...
							<!-- 修改 -->
							<td><a href="UpdateMap1?MapId=<%=list.get(i).getMapId()%>"><span
									class="glyphicon glyphicon-pencil"></span></a></td>
							<!-- 删除 -->
							<td><a href="DeleteMap?MapId=<%=list.get(i).getMapId()%>"><span
